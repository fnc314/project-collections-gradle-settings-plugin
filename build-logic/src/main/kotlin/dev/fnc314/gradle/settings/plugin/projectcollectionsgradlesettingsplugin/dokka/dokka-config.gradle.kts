...
import dev.fnc314.gradle.settings.plugin.projectcollectionsgradlesettingsplugin.dokkaDocsDirectory
import dev.fnc314.gradle.settings.plugin.projectcollectionsgradlesettingsplugin.dokkaDocsIntermediateDirectory
import dev.fnc314.gradle.settings.plugin.projectcollectionsgradlesettingsplugin.kotlinVersion
import dev.fnc314.gradle.settings.plugin.projectcollectionsgradlesettingsplugin.libs
