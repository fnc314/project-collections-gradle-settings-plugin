...
package gradle.kotlin.dsl.plugins._d5c7d2ebe258233dbf0a3dd448dd8d32
...
/**
 * The `com.gradle.plugin-publish` plugin implemented by [com.gradle.publish.PublishPlugin].
 */
internal
val `ComGradlePluginGroup`.`plugin-publish`: PluginDependencySpec
    get() = plugins.id("com.gradle.plugin-publish")
...
/**
 * The `org.gradle.plugin-compatibility` plugin implemented by [org.gradle.plugin.compatibility.internal.CompatibilityPlugin].
 */
internal
val `OrgGradlePluginGroup`.`plugin-compatibility`: PluginDependencySpec
    get() = plugins.id("org.gradle.plugin-compatibility")
